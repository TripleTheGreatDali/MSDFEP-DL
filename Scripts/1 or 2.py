...
dataset = CustomDataset(xlsx_file='label_1_or_2.xlsx',
                        root_dir=r'1_or_2\imgs\*.png',
...
model.load_state_dict(torch.load("VGG_1_or_2_best.pth"))
# 定义损失函数
